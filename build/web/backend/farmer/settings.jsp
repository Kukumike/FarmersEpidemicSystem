        ...
        <div class="container" style="margin-top: 50PX;">
            <div class="row" >
                ...
                <div class="col-md-9">
                    ...
                    <div class="alert alert-warning" id="alert_status" >A confirmation email was sent to <strong><%=user.getUserEmail()%></strong>. Please verify your account!</div>
                                            ...
                                            <div class="col-md-7">
                                                <form class="form account-form" action="Settings" method="post">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="userFullName" class="form-control" id="userFullName" placeholder="${user.user_full_name}" tabindex="1">
                                                    </div> <!-- /.form-group -->
                                                    <div class="form-group">
                                                        <label>User Phone:</label>
                                                        <input type="text" name="userPhone" class="form-control" id="userPhone" placeholder="${user.user_phone}" tabindex="1">
                                                    </div> <!-- /.form-group -->
                                                    <div class="form-group">
                                                        <label>Email Address</label>
                                                        <input type="text" name="" class="form-control" id="userEmail" value="${user.user_email}" tabindex="1" disabled>
                                                    </div> <!-- /.form-group -->
