...
<html>
    ...
    <body style="background-color: #f9f9f9;font-family:'Oxygen-Regular';" onload="notify();">
            ...
            <div class="nav-two">
                <div class="container">
                    <ul class="nav nav-tabs" role="tablist" id="myTab">
                        ...
                        <li>
                            <a href="#search-page" role="tab" data-toggle="tab">
                                Search Epidemic
                            </a>
                        </li>
                        <li class="list-sep"></li>                        
                        <li class="hidden">
                            <a href="#notification-page" role="tab" data-toggle="tab">
                                Notification <span class="badge pull-left">42</span> 
                            </a>
                        </li> 
                        <li class="list-sep"></li>
                    </ul>
        ...
        <div class="tab-content">
            ...
            <div id="notification-page" class="tab-pane fade">
                <div class="container">
                    <%@include  file="notification-page.jsp" %>
                </div><!-- /.container -->
            </div>
            <div id="search-page" class="tab-pane fade">
                <div class="container">
