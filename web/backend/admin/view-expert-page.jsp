<%-- 
    ...
    Created on : Mar 31, 2017, 2:56:36 PM
    ...
    <div class="main-panel">
        <div class="container">
            <div class="login-brand">
                <h2 class="text-center">Search for Expert Details</h2>
            </div>
            <!--login form-->
            <div class="panel panel-signup">
                <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-md-7">
                                <div class="form-group">
                                    <input type="text" class="form-control" style="width: 100%;border-radius: 0px;height: 48px;"placeholder="SEARCH EXPERTS">
                                </div>
                            </div>
                            <div class="col-md-5">
                                <div class="form-group">
                    ...
                    <hr>
                    <h4 class="">Search for Expert Details</h4>
                    <div class="row"
                         <div class="media">
